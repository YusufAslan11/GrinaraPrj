...
import pojos.LessonCreatePojo;
import pojos.LessonDeletePojo;
import pojos.LessonGetResponsePojo;
...
public class ViceDean_LessonCreate_Stepdef_api {
    LessonCreatePojo lessonExpectedData;
    LessonCreatePojo lessonActualDataGet;

    LessonResponsePojo lessonActualData;
    ...
    public void kullaniciViceDeanOlarakExpectedDataYiOlusturur(String lessonId, String compulsory, String creditScore, String lessonName) throws JsonProcessingException {
        lessonExpectedData = new LessonCreatePojo(lessonId, compulsory, creditScore, lessonName);
    ...
    public void kullanici_post_request_yaparak_lesson_olusturur() throws JsonProcessingException {
        ...
        lessonActualData = ObjectMapperUtils.convertJsonToJava(response.asString(), LessonResponsePojo.class);
    ...
    public void kullanici_vice_dean_olarak_olusturdugu_datayi_dogrular() {
        ...
        lessonActualData = response.as(LessonResponsePojo.class);
    ...
    public void kullaniciViceDeanOlarakCagirdigiDatayiDogrular() throws JsonProcessingException {
        ...
        lessonActualDataGet = response.as(LessonGetResponsePojo.class).getObject();
...
//        assertEquals(lessonExpectedData.getCompulsory(), lessonActualDataGet.getCompulsory());
    ...
    public void kullaniciViceDeanOlarakDeleteIcinBaseUrlOlusturur() {
        //https://managementonschools.com/app/lessons/delete/1869
        specViceDean.pathParams("first","lessons","second","delete","third","1907");
    ...
    public void kullaniciGetRequestYaparakLessonSiler(){
          lessonDeleteActualData= response.as(LessonDeletePojo.class).getMessage();
          System.out.println("lessonDeleteActualData = " + lessonDeleteActualData);

      }


    @And("kullanici ViceDean olarak delete icin cagirdigi datayi dogrular")
    public void kullaniciViceDeanOlarakDeleteIcinCagirdigiDatayiDogrular() {
        assertEquals("Lesson Deleted", lessonDeleteActualData);
